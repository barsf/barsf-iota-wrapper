...
import cn.zhonggu.barsf.iri.analysis.RodbDataFishingRunner;
...
import static cn.zhonggu.barsf.iri.analysis.RodbDataFishingRunner.synced;
...
public class BarsfIriStartup {
    ...
    private static String[] reduceParams(String[] args) {
